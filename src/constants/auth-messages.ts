...
export const AUTH_MESSAGES = {
  ...
  register: {
    ...
    passwordTooCommon: 'كلمة المرور شائعة جداً، يرجى اختيار كلمة مرور أقوى',
    passwordLeaked: 'كلمة المرور هذه موجودة في قاعدة بيانات مسربة، يرجى اختيار كلمة مرور أخرى',
  },
